  ...
  function handleModifyProduct() {
    try {
      ...
      if (!productId || (!title && !price && !description && !image)) {
        setErrorMessage('Product ID and at least one parameter (title, price, description, image) should be provided for modification');
        return;
      }
  ...
  return (
    <div className={style.container}>
      ...
      <div>
        ...
        <input type="text" value={image} onChange={function (e) { setImage(e.target.value); }} />
      </div>
      ...
      <div>
        ...
        <input type="text" value={productId} onChange={function (e) { setProductId(e.target.value); }} />
      </div>
